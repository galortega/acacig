  ...
  return (
    <div class="container">
      <main id="main" tabindex="-1">
        <div class="row">
          <div class="col-md-12">
            <h1 class="titulos-primarios">Actividades</h1>
          </div>
        </div>
        <div class="row espaciado-filas">
          <div class="col-md-6 col-xs-12">
            <h2 class="titulos-secundarios">Talleres de desarollo personal</h2>
            <p>
          ...
          <div class="col-md-6 col-xs-12">
            <img
              class="imagenes-actividades"
              src={`${baseImg}/desarrollo-emocional.jpg`}
        ...
        <div class="row espaciado-filas">
          <div class="col-md-6 col-xs-12">
            <img
              class="imagenes-actividades"
              src={`${baseImg}/asistencia-psicologica.jpg`}
              alt="Imagen de una mujer recibiendo asistencia psicológica."
            />
          </div>
          <div class="col-md-6 col-xs-12">
            <h2 class="titulos-secundarios">Asistencia Psicológica</h2>
            <p>
        ...
        <div class="row espaciado-filas">
          ...
          <div class="col-md-6 col-xs-12">
            <img
              class="imagenes-actividades"
              src={`${baseImg}/apredizaje-braille.jpg`}
